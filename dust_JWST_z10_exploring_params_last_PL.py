...
# Fixing power law index for the sf efficiency
alpha_e=0.5

### Computing Stellar properties at the given z
Mstar_array=halo_to_stellar_mass_pl(Mh_array, fb, epsilon,alpha_e)# Stellar masses corresponding to Mh_array at z=10, in [Msun] units
Mstar_array_05=halo_to_stellar_mass_pl(Mh_array, fb, 0.5,alpha_e)# Stellar masses corresponding to Mh_array at z=10, in [Msun] units
Mstar_array_01=halo_to_stellar_mass_pl(Mh_array, fb, 0.1,alpha_e)# Stellar masses corresponding to Mh_array at z=10, in [Msun] units
print('\n#########################################')
...
for j in range(len(Mh_array)):
    ...
    SFH, logMst_build, age =Build_SFH_funct_pl(Mh_array[j],redshift,tstep,epsilon,alpha_e)
...
SFH, logMst_build, age =Build_SFH_funct_pl(Mh_array[3],10.,1,0.1,alpha_e)
print('SFH-->', SFH)
Lnu_SB99_arr=[]
...
for epsilon in arr_e:
    for yd in arr_yd:
        ...
        Mstar_array = halo_to_stellar_mass_pl(Mh_array, fb, epsilon, alpha_e)
